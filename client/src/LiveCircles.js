    ...
    return (
        <div className="WrapperLiveCircles">
                <div className="outGroup">
                    <span className="glanceSpan">{`There are ${dataLiveGame.liveData.linescore.outs} outs`}</span>
                ...
                <div className="strikeGroup">
                    <span className="glanceSpan">{`${dataLiveGame.liveData.linescore.strikes} Strikes`}</span>
                ...
                <div className="ballGroup">
                    <span className="glanceSpan">{`${dataLiveGame.liveData.linescore.balls} Balls`}</span>
