...
function FieldingCard({fielderImage, fieldingData, averageSpeed, totalDistance, longestDistance }){
        ...
        <div className="playerFieldCard">
            ...
            <div className="cardInfo">
                <div className="sprintSpeed">
                    <h3 className="saberSpan">{`${fieldingData[0].name_display_first_last}'s Average Sprint Speed is`}</h3>
                ...
                <div className="distanceAndCatch">
                    <h3 className="saberSpan">{`${fieldingData[0].name_display_first_last} Has covered `}</h3>
                    <h5 className="saberSpan">{`${totalDistance.toFixed(2)} Feet: In the outfield`}</h5>
