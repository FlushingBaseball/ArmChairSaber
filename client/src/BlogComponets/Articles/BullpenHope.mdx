...
## Click on a card to flip it
 ...
 <div className='Article-Card-Divs'>
    <FlipCard frontText={firstCardData.frontText} backText={firstCardData.backText} />
    <FlipCard frontText={secondCardData.frontText} backText={secondCardData.backText} />
    <FlipCard frontText={thirdCardData.frontText} backText={thirdCardData.backText} />
