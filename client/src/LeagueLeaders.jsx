...
function LeagueLeaders() {
  ...
  useEffect(() => {
    fetch(
      `https://statsapi.mlb.com/api/v1/stats/leaders?leaderCategories=${selectedCata}&sportId=1&limit=20&season=2025&fields=leagueLeaders,leaders,rank,value,team,name,league,name,person,id,fullName`
    )
      .then((resp) => resp.json())
      .then((data) => {
