...
return(
        ...
        <div className="LiveGameScoreBoard">
                                    ...
                                    <div className="bigOldScoreNums">
                                            <span className="scoreNum">{dataLiveGame.liveData.linescore.teams.home.runs}</span>
                                                    <span className="scoreNum"> - </span>
                                            <span className="scoreNum">{dataLiveGame.liveData.linescore.teams.away.runs}</span>
                                    </div>
